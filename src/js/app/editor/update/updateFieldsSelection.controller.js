var updateFieldsSelectionController = ['$scope', '$uibModal', '$rootScope', '$timeout', '$state', 'taskData', 'pageData', 'postData', 'postService',
function updateFieldsSelectionController($scope, $uibModal, $rootScope, $timeout, $state, taskData, pageData, postData, postService) {
...
export default updateFieldsSelectionController;
