define([
    ...
    var updateFieldsDoneController = /*@ngInject*/ function updateFieldsDoneController(PERMALINK_URL, $scope, $location, $timeout, taskData, pageData, postData, stepService, entryService, $rootScope, $sessionStorage, errorService, $state) {
