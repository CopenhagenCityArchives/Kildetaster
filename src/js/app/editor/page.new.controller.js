var pageNewController = ['$timeout', '$state', '$uibModal', '$scope', '$rootScope', 'taskData', 'taskUnitData', 'pageData', 'isDone', 'pageService',
function pageNewController($timeout, $state, $uibModal, $scope, $rootScope, taskData, taskUnitData, pageData, isDone, pageService) {
