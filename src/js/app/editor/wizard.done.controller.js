var wizardDoneController = ['$scope', '$state', 'pageData', 'taskData', 'pageService',
function wizardDoneController($scope, $state, pageData, taskData, pageService) {
...
export default wizardDoneController;