define([
    ...
    var updateFieldsController = /*@ngInject*/ function updateFieldsController($uibModal, SEARCH_PERMALINK_URL, Flash, $scope, $location, $timeout, taskData, pageData, postData, stepService, entryService, $rootScope, $sessionStorage, errorService, $state, helpers) {
        ...
        $scope.shareLink = SEARCH_PERMALINK_URL + '/post/' + taskData.collection_id + '-' + postData.entryData.concrete_entries_id;
