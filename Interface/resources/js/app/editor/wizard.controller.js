define([
    ...
    var wizardController = /*@ngInject*/ function wizardController($uibModal, helpers, $scope, $rootScope, postService, stepService, pageData, taskData, $state, $timeout, $http, API_ENDPOINT, pageService, SEARCH_PERMALINK_URL, Analytics, $transitions, $q) {
        ...
        */
        $scope.$watch('shareLinkId', function(newVal) {
            ...
            if (newVal !== undefined) {
                var link = SEARCH_PERMALINK_URL + '/post/' + newVal;
