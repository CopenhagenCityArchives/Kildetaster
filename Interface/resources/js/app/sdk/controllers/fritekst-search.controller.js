define([
    ...
    var fritekstSearchController = /*@ngInject*/ function fritekstSearchController($scope, $location) {
        ...
        $scope.search = function search() {
            ...
            document.location.href = $scope.searchUrl + '#/results?q1.f=freetext_store&q1.op=eq&q1.t=' + term +'&sortField=lastname&sortDirection=asc&postsPrPage=10&collections=1,17,18';
        }
