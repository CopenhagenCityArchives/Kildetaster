module.exports = {
    ...
    prototype: {
        constants: {
            ...
            ERRORREPORCONFIGURL: 'http://localhost:1510/resources/configs/errorreport.json',
    ...
    development: {
        constants: {
            ...
            ERRORREPORCONFIGURL: 'http://kbhkilder.dk/software/kildetaster-development/resources/configs/errorreport.json',
            MAINDOMAIN: 'https://www.kbharkiv.dk',
            TOKENURL: 'https://www.kbharkiv.dk/index.php?option=authorize&response_type=token&client_id=kbhkilder&api=oauth2',
            ERRORURL: 'http://www.kbharkiv.dk/deltag/indtast-data-fra-arkivmateriale',
            SEARCHURL: 'http://www.kbharkiv.dk/sog-i-arkivet/sog-efter-personer',
    ...
    production: {
        constants: {
            ...
            ERRORREPORCONFIGURL: 'http://kbhkilder.dk/software/kildetaster/resources/configs/errorreport.json',
            MAINDOMAIN: 'https://www.kbharkiv.dk',
            TOKENURL: 'https://www.kbharkiv.dk/index.php?option=authorize&response_type=token&client_id=kbhkilder&api=oauth2',
            ERRORURL: 'http://www.kbharkiv.dk/deltag/indtast-data-fra-arkivmateriale',
            SEARCHURL: 'http://www.kbharkiv.dk/sog-i-arkivet/sog-efter-personer',
